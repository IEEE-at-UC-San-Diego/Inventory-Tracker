import { Package, Search, FolderOpen, Inbox, FileQuestion, Plus } from 'lucide-react'
...
export function NoResultsState({ searchQuery, onClear }: { searchQuery: string; onClear: () => void }) {
  return (
    <EmptyState
