...
import { Loader2, Settings, AlertTriangle, Package } from 'lucide-react'
...
export function AdjustDialog({
  ...
  const currentInventory = inventoryId
    ? availableInventory?.find((item) => item._id === inventoryId)
    : availableInventory?.find((item) => item.compartmentId === selectedCompartmentId)
  ...
  const handleSubmit = useCallback(async (e: React.FormEvent) => {
    ...
    try {
      const compartmentId = selectedCompartmentId || currentInventory?.compartmentId
          ...
          <div className="space-y-4 py-4">
            ...
            <div className="p-3 bg-amber-50 border border-amber-200 rounded-lg flex items-start gap-3">
              ...
              <div>
                ...
                <p className="text-sm text-amber-700">
                  This creates an adjustment transaction. A reason is required for audit purposes.
                </p>
              </div>
            </div>
              ...
              <div className="p-4 bg-blue-50 border border-blue-200 rounded-lg">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-2xl font-bold text-blue-700">{currentQuantity}</p>
                  </div>
                </div>
              </div>
            )}
            ...
            <div className="space-y-2">
              ...
              <p className="text-sm text-gray-500">
                Difference: {' '}
                <span className={newQuantity - currentQuantity >= 0 ? 'text-green-600' : 'text-red-600'}>
