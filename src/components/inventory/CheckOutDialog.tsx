...
import { Loader2, Minus, Package, MapPin, AlertTriangle } from 'lucide-react'
...
export function CheckOutDialog({
  ...
  const selectedLocation = locations.find((l) => l.compartmentId === selectedCompartmentId)
        ...
        <form onSubmit={handleSubmit}>
            ...
            <div className="space-y-2">
              ...
              {locations.length === 0 ? (
                <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-lg flex items-start gap-3">
                  ...
                  <div>
                    <p className="font-medium text-yellow-800">No inventory available</p>
                ...
                <div className="space-y-2">
                  {locations.map((location) => (
                    <button
                      ...
                      type="button"
                      onClick={() => setSelectedCompartmentId(location.compartmentId)}
          ...
          <DialogFooter>
            ...
            <Button
              type="submit"
              variant="destructive"
              disabled={isSubmitting || !selectedCompartmentId || quantity <= 0 || quantity > maxQuantity}
            >
              {isSubmitting ? (
                <>
